...
local Z= "NyxHub_FlightSpeed.txt"
local z= "NyxHub_EggSelectConfig.json"
...
-- ============================================================
-- ADDED FEATURES: Egg ESP (HUD), Server Hop, Webhook (NYX style)
...
local function nyxRarityColor(rarity)
	...
	-- monochrome hierarchy: higher rarity = brighter white
	local rank = ({
		Divine = 1, Eternal = 0.92, Secret = 0.85, Cosmic = 0.78,
		Mythic = 0.7, Legendary = 0.62, Epic = 0.52, Rare = 0.42,
		Uncommon = 0.32, Common = 0.22,
	})[t] or 0.35
	local v = math.floor(40 + rank * 215)
	return Color3.fromRGB(v, v, v), rank
end
...
-- Webhook — NYX monochrome embed style (not the usual colorful bot style)
local function nyxWebhook(title, description, fields)
	...
	local embed = {
		title = "NYX · " .. tostring(title or "Event"),
		description = tostring(description or ""),
		color = 0xE8E8E8, -- near-white accent
		footer = { text = "NYX HUB · Steal an Egg" },
...
local function aM(...) h.alive = false pcall(nyxEspStop)pcall(Ik)pcall(Ak)pcall(function(...) y:Set3dRenderingEnabled( true )
        ...
        local y=r:FindFirstChild( "NyxHub_EggESP" )
        if y then
            y:Destroy()
        end
    end
    ...
    pcall(function(...)
        for r,y in ipairs(game.CoreGui :GetChildren())do
            if y.Name :find( "Nyx_" )or y.Name :find( "NyxHubUI" )or y.Name :find( "WindUI" )then
                y:Destroy()
            end
        end
    end
...
local function oM(...)
    ...
    local function j(e,...)
        ...
        if not y then
            pcall(function(...)
                (game:GetService( "StarterGui" )):SetCore( "SendNotification" ,{[ "Title" ]=tostring(e.Title or "NYX HUB" ),[ "Text" ]=tostring(e.Content or "" );
                [ "Duration" ]= 3 })
            end
            )
        end
    ...
    if r then
        pcall(function(...)
            ...
            if e then
                r.Notify =function(r,y,...)
                    ...
                    if not u then
                        pcall(function(...)
                            (game:GetService( "StarterGui" )):SetCore( "SendNotification" ,{[ "Title" ]=tostring(y and y.Title or "NYX HUB" );
        ...
        -- Monochrome NYX theme (black / white)
        pcall(function()
            r:AddTheme({
                Name = "NYX",
        ...
        -- NYX logo for built-in minimize bubble
        local nyxLogoAsset = "hexagon"
        pcall(function()
            local logoPath = "nyx_hub_logo.png"
            if writefile and getcustomasset then
                if not (isfile and isfile(logoPath)) then
                    local b64 = ""
                    local raw = (crypt and crypt.base64decode and crypt.base64decode(b64))
                        or (base64 and base64.decode and base64.decode(b64))
                    if not raw and typeof(base64_decode) == "function" then
                        raw = base64_decode(b64)
                    end
                    if type(raw) == "string" and #raw > 100 then
                        writefile(logoPath, raw)
                    end
                end
                if isfile and isfile(logoPath) then
                    nyxLogoAsset = getcustomasset(logoPath)
                end
            end
        end)
        ...
        Ok=p:Tab({[ "Title" ]=P.Tabs.EggSelect or "Preference" ; [ "Icon" ]= "lucide:settings-2" })
        Tk=p:Tab({[ "Title" ]=P.Tabs.Settings ; [ "Icon" ]= "solar:settings-bold" })
        MkTab=p:Tab({[ "Title" ]= "Misc" ; [ "Icon" ]= "lucide:layout-grid" })
        Yk=Ok
        local N= false
        local U=nil
        local l=nil
        hk:Section({[ "Title" ]= "Farm" })
        Fk.togTween =hk:Toggle({[ "Title" ]=P.Farm.TweenTitle ,[ "Desc" ]=P.Farm.TweenDesc ,[ "Icon" ]= "solar:compass-bold" ;
        ...
        [ "Desc" ]=P.Farm.PlaceDesc or "Automatically place eggs at base" ;
        [ "Icon" ]= "solar:box-bold" ;
        ...
        [ "Desc" ]=P.Farm.AutoTreadmillDesc or "Run on treadmill when idle" ;
        ...
        [ "Desc" ]=P.Farm.UpgradeTreadmillDesc or "Upgrade treadmill when you have enough cash" ;
        [ "Icon" ]= "solar:double-alt-arrow-up-bold" ;
        [ "Value" ]=(h.autoUpgradeTreadmill == true) ,[ "Callback" ]=function(e,...) h.autoUpgradeTreadmill =e x()
        ...
        [ "Desc" ]=P.Farm.BuyTrailsDesc or "Buy and equip the best trail" ;
        ...
        [ "Desc" ]=(P.EggSelect and P.EggSelect.AlwaysSecretPlusDesc )or "Always collect Secret and above" ;
        ...
        [ "Callback" ]=function(e,...)
            if e then
                enableNyxGodmode()j({[ "Title" ]= "Godmode" ,[ "Content" ]=Gk[Xk].Notifications.GodmodeStarted ,[ "Icon" ]= "shield-check" })
            else
        ...
        Fk.togAntiAFK =Tk:Toggle({[ "Title" ]=(P.Settings and P.Settings.AntiAFKTitle )or "Anti AFK" ,[ "Desc" ]=(P.Settings and P.Settings.AntiAFKDesc )or "Prevent being kicked for inactivity" ;
        ...
        Fk.togEggESP = Ok:Toggle({
            ...
            Callback = function(state)
                ...
                if state then
                    nyxEspStart()
                    j({ Title = "Egg ESP", Content = "HUD online", Icon = "eye" })
                else
                    nyxEspStop()
        ...
        Fk.togAutoHop = MkTab:Toggle({
            ...
            Callback = function(state)
                ...
                if state then
                    j({ Title = "Server Hop", Content = string.format("%d / %d hops used", h.hopCount or 0, h.maxHops or 15), Icon = "server" })
                end
            end,
        })
        ...
        Fk.togFpsBoost = MkTab:Toggle({
            ...
            Callback = function(state)
                if state then
                    Mk()
                    j({ Title = "FPS", Content = "Boost on", Icon = "gauge" })
                else
                    Ik()
        ...
        Fk.togWebhook = MkTab:Toggle({
            ...
            Desc = "NYX monochrome Discord embeds",
            Icon = "bell",
            Value = false,
            Callback = function(state)
                h.webhookEnabled = state and true or false
                if state and (h.webhookUrl or "") ~= "" then
                    nyxWebhook("Online", "Webhook linked to NYX HUB.")
                end
            end,
        })
        ...
        Fk.btnWebhookTest = MkTab:Button({
            ...
            Callback = function()
                ...
                nyxWebhook("Test", "steal an egg script webhook is working rn", {
                    ...
                    { name = "Hub", value = "NYX HUB", inline = true },
                })
    ...
    local k=Instance.new ( "ScreenGui" )k.Name = "NyxHubUI_v41_5" k.ResetOnSpawn = false k.DisplayOrder = 99999 k.ZIndexBehavior =Enum.ZIndexBehavior.Sibling k.AutoLocalize = false
    ...
    local l=Instance.new ( "TextLabel" )l.Size =UDim2.new ( 1 , -90 , 0 , 22 )l.Position =UDim2.new ( 0 , 12 , 0 , 6 )l.BackgroundTransparency = 1 l.Text = "NYX HUB (Fallback)" l.TextColor3 =B l.TextSize = 14 l.Font =Enum.Font.GothamBold l.TextXAlignment =Enum.TextXAlignment.Left l.AutoLocalize = false l.Parent =U
    local D=Instance.new ( "TextLabel" )D.Size =UDim2.new ( 1 , -90 , 0 , 14 )D.Position =UDim2.new ( 0 , 12 , 0 , 26 )D.BackgroundTransparency = 1 D.Text = "NYX HUB v1.0" D.TextColor3 =Color3.fromRGB ( 155 , 155 , 155 )D.TextSize = 11 D.Font =Enum.Font.Gotham D.TextXAlignment =Enum.TextXAlignment.Left D.AutoLocalize = false D.Parent =U
...
H( "[+] Initializing NYX HUB x WindUI v1.0 (NYX HUB Edition)..." )oM()task.spawn (function(...) task.wait ( 0.5 )A4()b4( true )C4()
    if o.Character then
        z4(o.Character )
    end
